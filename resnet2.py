...
def get_network(X):
    ...
    return net,net6,net3,net3c,net2,net2c,net1
...
if __name__ == "__main__":
    ...
    if( len(sys.argv) > 1 ):
        ...
        clf_name = "resnet" if len(sys.argv) <= 2 else sys.argv[2]
